...
#   kernelspec:
#     display_name: Python (demo_tf)
#     language: python
#     name: demo_tf
# ---

# %set_env CLOUD_ML_PROJECT_ID="adeo-tests"
# %set_env AIP_TRAINING_DATA_URI=bq://adeo-tests.irisdataset.iris_val
# %set_env AIP_VALIDATION_DATA_URI=bq://adeo-tests.irisdataset.iris_val
# %set_env AIP_TEST_DATA_URI=bq://adeo-tests.irisdataset.iris_test
# %set_env AIP_DATA_FORMAT=".csv"
# %set_env AIP_MODEL_DIR=saved_model_iris
# %env
...
# !gsutil cp -r saved_model_iris gs://iris_demo
